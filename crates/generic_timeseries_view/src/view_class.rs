...
use rerun::{
    ...
    external::{
        ...
        nohash_hasher, re_chunk_store, re_format, re_log_types, re_sdk_types, re_ui, re_view,
        re_viewer_context,
    },
};
...
impl ViewClass for TimeSeriesView {
    ...
    fn choose_default_visualizers(
        ...
        _visualizable_entities_per_visualizer: &PerVisualizerInViewClass<VisualizableEntities>,
    ...
    fn ui(
        ...
        let time_offset = match timeline.typ() {
            TimeType::Sequence => min_view_time,
            TimeType::TimestampNs | TimeType::DurationNs => {
                ...
                round_nanos_to_start_of_day(min_view_time)
            }
        };
